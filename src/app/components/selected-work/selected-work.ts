...
export class SelectedWork implements OnInit {
  ...
  workItems: any[] = [
    ...
    {
      title: 'Team Malizia',
      description: 'Helping transform offshore sailing, climate science and team stories into compelling video content for international audiences.',
      client: 'whoever',
    ...
    },
    {
      ...
      description: 'Creating clear, social-first visual content to support Mediterranean marine protection and campaign communication.',
      client: 'whoever',
